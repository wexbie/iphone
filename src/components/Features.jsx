      ...
      <div className="screen-max-wdith">
        ...
        <div className="flex flex-col justify-center items-center overflow-hidden">
          <div className="mt-32 mb-24 pl-24">
            ...
            <h2 className="text-5xl lg:text-7xl font-semibold">Titanyumdan yaratıldı.</h2>
          </div>
                ...
                <div className="flex-1 flex-center">
                  <p className="one-cikan-yazi g_text">
                    ...
                    <span className="text-white">
                      havacılık ve uzay endüstrisi standartlarında titanyum tasarıma sahip ilk iPhone
                    </span>.Öyle ki,
                    Mars görevlerindeki uzay araçlarında da aynı alaşım kullanılıyor.
                  </p>
                </div>
                <div className="flex-1 flex-center">
                  <p className="one-cikan-yazi g_text">
